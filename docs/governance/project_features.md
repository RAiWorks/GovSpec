...
|------------|--------------|--------|----------|------------|--------------|--------------|-------------|-------------|--------------|--------------|-------|
| 01 | GovSpec Web App | draft | critical | — | Project Owner | 2026-02-06 | — | — | — | `docs/features/01_govspec_web_app.md` | Core application for managing GovSpec via web UI and API |
